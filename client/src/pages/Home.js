    ...
    <div className="home">
      <div className="BodyContainer p-2">
        ...
        <div className="searchBox">
          ...
          />
          <button className="btn" onClick={(e) => getWeatherDetails(e)}>
            <FaSearch />
          </button>
        </div>
        ...
        {pnfVisible ? (
          <div className="text-center">
            <img
              ...
              alt="pnf"
              src="https://static.vecteezy.com/system/resources/thumbnails/011/314/479/small_2x/illustrations-woman-using-binocular-looking-internet-connections-for-oops-404-error-design-concept-landing-page-vector.jpg"
            />
          </div>
        ) : (
          <>
            {icon && (
              <div>
                <div className="text-center">
                  ...
                  />
                  <h4>
                    {Math.round(otherDetails?.temp - 273.15)}
                    <RiCelsiusFill />
                  </h4>
                  <h2>{main}</h2>
                </div>
